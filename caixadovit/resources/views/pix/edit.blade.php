...
@section('conteudo')
    <div class="container-fluid my-4">
        <h2 style="margin-bottom: 15px; padding-top:15px;"> Editar Venda Pix</h2>
        ...
        <form  action="<?= url('/pix/update',['id' => $dado->id]);?>" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="mt-4 text-left">
                ...
                <a href="{{route('pix')}}" class="btn btn-secondary">Voltar</a>
            </div>
        </form>
    </div>
@endsection
